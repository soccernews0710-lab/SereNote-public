          ...
          <View style={styles.backdrop}>
            <View style={styles.container}>
              ...
              >
                ...
                {/* ⭐ スロット（朝/夜/頓服）の UI はいったん非表示のまま */}
                {/* 必要になったらここに chip を追加すればOK */}
                ...
                <View style={styles.reminderRow}>
                  ...
                  <Switch
                    value={linkToReminder}
                    onValueChange={setLinkToReminder}
                  />
                </View>
              </ScrollView>
